...
function metacriticAPI(system) {
    ...
    async function loadMetacriticPage(game_name) {
    ...
    async function searchMetacritic(query) {
        const searchUrl = 'https://www.metacritic.com/autosearch';
        const response = await axios.post(searchUrl, `search_term=${query}&image_size=98&search_each=true`, {
            headers: {
